...
<head>
    <meta charset="UTF-8">
    <title>Category-wise Item Sales Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="header">
            <div class="header-top">
                ...
                <div class="report-info">
                    <p><strong>Report:</strong> Category-wise Item Sales</p>
            ...
            <div class="report-title">CATEGORY-WISE ITEM SALES REPORT</div>
