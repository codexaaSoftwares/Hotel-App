...
class ProfileService {
  ...
  normalizeProfileData(user) {
    ...
    // Use avatar_url from backend (full URL generated by getStorageUrl)
    // Backend formatUserData method sets avatar_url with full URL
    const avatarUrl = getImageUrl(user.avatar_url, user.avatar)
