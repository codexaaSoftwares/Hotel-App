...
const normalizeItem = (item) => {
  ...
  return {
    ...
    gst_percentage: item.gst_percentage ? parseFloat(item.gst_percentage).toFixed(2) : null,
...
const serializeItem = (itemData) => {
  const serialized = {
    ...
    gst_percentage: itemData.gst_percentage ? parseFloat(itemData.gst_percentage) : null,
