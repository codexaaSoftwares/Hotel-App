    ...
    <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This document was generated automatically by Teja Hotel</p>
              <p style="margin-top: 5px;">© ${new Date().getFullYear()} Teja Hotel. All rights reserved.</p>
            </div>
          </div>
        </body>
    </html>
    ...
    <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This invoice was generated automatically by Teja Hotel</p>
              <p style="margin-top: 5px;">© ${new Date().getFullYear()} Teja Hotel. All rights reserved.</p>
            </div>
          </div>
        </body>
